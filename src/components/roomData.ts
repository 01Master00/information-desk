...
const groundFloorRooms: RoomDefinition[] = [
  ...
  {
    position: [2.8, 0.2, -0.01],
    size: [1.0, 5.8, 0.08],
    color: "rgb(201, 209, 224)",
    opacity: 0.28,
    label: "Folyoso - Foldszint gym kapcsolat",
  },
  {
    position: [1.4, -3.2, -0.01],
    size: [7.6, 1.0, 0.08],
    color: "rgb(201, 209, 224)",
    opacity: 0.28,
    label: "Folyoso - Foldszint terem kapcsolat",
  },
  {
    position: [-4.0, -4.2, -0.01],
    size: [3.6, 1.0, 0.08],
    color: "rgb(201, 209, 224)",
    opacity: 0.28,
